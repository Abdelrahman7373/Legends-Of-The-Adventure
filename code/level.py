					...
					if col != '-1':
						...
						if style == 'entities':
							if col == '394':
								...
								Enemy(monster_name, (x,y), [self.visible_sprites, self.attackable_sprites], self.obstacle_sprites, self.damage_player, self.trigger_death_animation, self.add_exp)
					...
					for target_sprite in collision_sprites:
						if target_sprite.sprite_type == 'grass':
							for leaf in range(randint(3,6)):
								self.animation_player.create_grass_particles(target_sprite.rect.center - pygame.math.Vector2(0,75), [self.visible_sprites])
							target_sprite.kill()
						else:
